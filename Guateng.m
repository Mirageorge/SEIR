...
Duration = 7; 
sigma = 1/Duration;
R_0 = 1.03*10; % RO for Beta variant https://www.gov.za/Coronavirus
N = 12272363; % https://www.gcro.ac.za/about/the-gauteng-city-region/
beta = R_0/(N*Duration); 


% Differential equations
I = 278516; %https://www.nicd.ac.za/latest-confirmed-cases-of-covid-19-in-south-africa-29-dec-2020/
S = N-I;
E = 0;
R = 0;
tspan1 = 0:1:37;
...
ylabel('Population')
title('Predicted Spread of B.1.351 - Guateng')
grid on;
grid minor;
...
xlabel('Days after December, 2020')
ylabel('Population')
title('Predicted infections of B.1.351 - Guateng')